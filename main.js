...
ParentBox.style.width = '100%';  
ParentBox.style.maxWidth = '1600px';  
ParentBox.style.margin = '0 auto';  
ParentBox.style.padding = '20px';  
ParentBox.style.boxSizing = 'border-box';  
...
obj.forEach(worker => {
    ...
    category.textContent = `Category: ${worker.category}`;
    image.src = worker.image;
    rate.textContent = `Rating: ${worker.rating.rate}`;
    ...
    box.append(title, price, description, category, image, rate);
